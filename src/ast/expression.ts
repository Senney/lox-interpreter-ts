...
export class AssignExpression extends Expression {
    constructor(public name: Token, public value: Expression) { super(); }
    accept<R>(visitor: ExpressionVisitor<R>): R { return visitor.visitAssignExpression(this); }
}
export class BinaryExpression extends Expression {
    constructor(public lhs: Expression, public operator: Token, public rhs: Expression) { super(); }
    accept<R>(visitor: ExpressionVisitor<R>): R { return visitor.visitBinaryExpression(this); }
}
export class CallExpression extends Expression {
    constructor(public callee: Expression, public paren: Token, public args: Expression[]) { super(); }
    accept<R>(visitor: ExpressionVisitor<R>): R { return visitor.visitCallExpression(this); }
}
export class GroupingExpression extends Expression {
    constructor(public expr: Expression) { super(); }
    accept<R>(visitor: ExpressionVisitor<R>): R { return visitor.visitGroupingExpression(this); }
}
export class LiteralExpression extends Expression {
    constructor(public value: unknown) { super(); }
    accept<R>(visitor: ExpressionVisitor<R>): R { return visitor.visitLiteralExpression(this); }
}
